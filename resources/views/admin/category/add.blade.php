            ...
            <tr>
                ...
                <td>
                    <select name="cate_pid">
                        <option value="0">==父分類==</option>
                        @foreach($data as $d)
                        <option value="{{$d->cate_id}}">{{$d->cate_name}}</option>
                        @endforeach
                    </select>
                    <span><i class="fa fa-exclamation-circle yellow"></i>需先決定父分類再決定子分類再從子分類設定商品</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span><i class="fa fa-exclamation-circle yellow"></i>父類新增標體圖片會顯示在前台的分類內(子分類可不設定)</span>
                </td>
            </tr>
            <tr>
