...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首頁</a> &raquo;友情連接管理
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <div class="short_wrap">
            <a href="{{url('admin/links/create')}}"><i class="fa fa-plus"></i>添加連接</a>
            <a href="{{url('admin/links')}}"><i class="fa fa-recycle"></i>全部連接</a>
        </div>
    </div>
</div>
<!--结果集标题与导航组件 结束-->
...
<div class="result_wrap">
    <form action="{{url('admin/links/'.$field->link_id)}}" method="post">
        ...
        <table class="add_tab">
            <tbody>
            <tr>
                <th><i class="require">*</i>連接名稱：</th>
                <td>
                    <input type="text" name="link_name" value="{{$field->link_name}}">
                    <span><i class="fa fa-exclamation-circle yellow"></i>連接名稱必須填寫</span>
                </td>
            </tr>
            <tr>
